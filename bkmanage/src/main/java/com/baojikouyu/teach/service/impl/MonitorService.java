...
import com.baojikouyu.teach.util.MonitorUtil;
...
public class MonitorService {
    ...
    public Map<String, Object> getSystemInfo(OperatingSystem os) {
        ...
        systemInfo.put("ip", MonitorUtil.getLocalIp());
        return systemInfo;
    }
     ...
     * @return /
     */
    public Map<String, Object> getSwapInfo(GlobalMemory memory) {
     ...
     * @return /
     */
    public Map<String, Object> getDiskInfo(OperatingSystem os) {
        ...
        diskInfo.put("total", total > 0 ? MonitorUtil.getSize(total) : "?");
        diskInfo.put("available", MonitorUtil.getSize(available));
        diskInfo.put("used", MonitorUtil.getSize(used));
        if (total != 0) {
